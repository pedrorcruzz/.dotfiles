...

  {
    ...
    config = function()
      require("treesitter-context").setup({
        enable = false, -- NOTE: Aqui que ativa o Sticky Scroll (true)
        max_lines = 0,
      })
      ...
      -- Mapeia <leader>z para o toggle
      vim.keymap.set("n", "<leader>z", toggle_context, { silent = true, desc = "Toggle: Sticky Scroll" })
    end,
  },
}
