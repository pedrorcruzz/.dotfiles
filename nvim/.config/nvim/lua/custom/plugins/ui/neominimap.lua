...
return {
  ...
  keys = {
    ...
    { '<leader>vo', '<cmd>Neominimap on<cr>', desc = 'Enable global minimap' },
    { '<leader>vc', '<cmd>Neominimap off<cr>', desc = 'Disable global minimap' },
    ...
    { '<leader>vwo', '<cmd>Neominimap winOn<cr>', desc = 'Enable minimap for current window' },
    { '<leader>vwc', '<cmd>Neominimap winOff<cr>', desc = 'Disable minimap for current window' },
    ...
    { '<leader>vto', '<cmd>Neominimap tabOn<cr>', desc = 'Enable minimap for current tab' },
    { '<leader>vtc', '<cmd>Neominimap tabOff<cr>', desc = 'Disable minimap for current tab' },
    ...
    { '<leader>vbo', '<cmd>Neominimap bufOn<cr>', desc = 'Enable minimap for current buffer' },
    { '<leader>vbc', '<cmd>Neominimap bufOff<cr>', desc = 'Disable minimap for current buffer' },
