return {
  ...
  opts = {
    ...
    picker = {
      ...
      hidden = false,
      ignored = true,
      layout = { preset = 'vscode', preview = true, border = rounded }, --default,telescope, vertical, ivy, dropdown, ivy_split,sidebar,vscode,select,top,right,left, bottom,
      sources = {
        files = {
          hidden = false,
          ignored = false,
        ...
        explorer = {
          ...
          layout = { layout = { position = 'left', width = 34 }, preview = false }, --explorer side width 40 default
          focus = 'list',
          auto_close = false,
          git_untracked = true,
