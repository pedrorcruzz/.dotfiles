...
M.config = function()
   lvim.builtin.which_key = {
      ...
      mappings = {
         ...
         --    "Find File Git",
         -- },
         ["f"] = { "<cmd>FzfLua git_files <CR>", "Find files Git" },
