...
M.config = function()
	lvim.builtin.which_key = {
		...
		mappings = {
			[";"] = { "<cmd>Alpha<CR>", "  Rosa Nvim" },
			["w"] = { "<cmd>w!<CR>", "  Save" },
			["q"] = { "<cmd>confirm q<CR>", " 󰩈 Quit" },
			-- ["/"] = { "<Plug>(comment_toggle_linewise_current)", "  Comment toggle current line" },
			["c"] = { "<cmd>BufferKill<CR>", " 󰅗 Close Buffer" },
			["f"] = { "<cmd>FzfLua files<CR>", "  Find file" },
			["["] = { "<cmd>bprevious<CR>", " 󰙣 Previous" },
			["]"] = { "<cmd>bnext<CR>", " 󰙡 Next" },
			["r"] = { "<cmd>lua require('renamer').rename()<CR>", " 󰑕 Renamer" },
			["x"] = { "<cmd>set wrap<CR>", " 󰖶 Wrap" },
			["z"] = { "<cmd>ZenMode<CR>", " ⏾ ZenMode" },
			["y"] = { "<cmd>Yazi<CR>", " 󰥨 Yazi" },
			...
			g = {
				...
				s = { "<cmd>FzfLua git_stash<cr>", "Open Stash" },
				t = { "<cmd>FzfLua git_tags<cr>", "Open Tags" },
				x = { "<cmd>FzfLua git_blame<cr>", "Open Blame" },
				C = {
			...
			s = {
				name = "  Search",
				a = { "<cmd>FzfLua args<cr>", "Args" },
				s = { "<cmd>FzfLua lsp_document_symbols<cr>", "Symbols" },
				d = { "<cmd>FzfLua lsp_definitions<cr>", "Go to Definition" },
				e = { "<cmd>FzfLua<cr>", "Fzf Menu" },
				w = { "<cmd>FzfLua changes<cr>", "Search changes" },
				h = { "<cmd>FzfLua search_history<cr>", "Search History" },
				f = { "<cmd>FzfLua git_files<cr>", "Find Git File" },
				i = { "<cmd>FzfLua spell_suggest <cr>", "Spell Suggest" },
				g = { "<cmd>Telescope current_buffer_fuzzy_find<cr>", "Find Text in Buffer" },
				j = { "<cmd>FzfLua jumps<cr>", "Jumps file" },
				m = { "<cmd>FzfLua marks<cr>", "Marks file" },
				M = { "<cmd>FzfLua manpages<cr>", "Manual Pages" },
				r = { "<cmd>FzfLua oldfiles<cr>", "Open Recent File" },
				q = { "<cmd>FzfLua registers<cr>", "Registers" },
				...
				S = { "<cmd>FzfLua spell_suggest<cr>", "Spell Suggest" },
